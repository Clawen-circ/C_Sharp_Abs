...
Если один оперант имеет значение decimal, то второй становится decimal. Исключение: Второй не должен быть float или double;
Если один оперант имеет значение double, то второй становится double;
Если один оперант имеет значение float, то второй становится float;
